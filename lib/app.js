...
var transmissionRoutes = require('./routes/api/transmission');
var sickbeardRoutes = require('./routes/api/sickbeard');
var couchpotatoRoutes = require('./routes/api/couchpotato');
...
app.use('/transmission', transmissionRoutes);
app.use('/sickbeard', sickbeardRoutes);
app.use('/couchpotato', couchpotatoRoutes);
